...
<h1 align="center">
  <a href="https://mobius.nutshellai.cn/">
    <img src="./mobius/extension/mobius-home/frontend/favicon.svg" width="56" alt="Mobius Logo" />
  </a>
  <br/>
...
```mermaid
flowchart LR
    A["An idea"] --> B["Project<br/>Project & context"]
    B --> C["Issue<br/>Goal & acceptance criteria"]
    C --> D["Session<br/>Real agent execution"]
    D --> E["Test · Verify · Deliver"]
    E --> F["Products · Tools · Research outcomes"]
