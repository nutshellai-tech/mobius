...
function createFallbackApi(canvas, container) {
...
export function initMobiusRing(canvas, options = {}) {
  ...
  try {
    ...
    console.warn('[self-cognition] WebGL ring unavailable; continuing without 3D scene.', error);
    return createFallbackApi(canvas, container);
  }
