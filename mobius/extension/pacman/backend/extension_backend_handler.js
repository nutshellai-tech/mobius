/**
 * pacman/backend/extension_backend_handler.js — 吃豆人样例 handler.
 *
 ...
 *
 * 路由: 由 ext_main_payload.action 分发
 *   - get_leaderboard          → 返回 top 10
...
module.exports = async function pacmanHandler({
  username,
  display_name,
  ext_main_payload,
  ext_data_dir,
  ...
  if (action === 'submit_score') {
    ...
    logger && logger.info('submit_score', { username, score, rank });
    return {
      ok: true,
