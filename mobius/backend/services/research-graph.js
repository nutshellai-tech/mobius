...
function resolveGraphFile(researchId) {
...
function extractRawNodes(parsed) {
...
function resolveGraphImage(researchId, requestedPath) {
  const resolved = resolveGraphFile(researchId);
  if (resolved.error) return resolved;
