...
export function WindowControls() {
  ...
  return (
    <div className="flex items-stretch flex-shrink-0 no-drag" style={{ height: 48, marginLeft: 6 }}>
      <button type="button" title="最小化" aria-label="最小化"
        ...
        <svg width="11" height="11" viewBox="0 0 11 11"><rect y="5" width="11" height="1.1" fill="currentColor" /></svg>
      </button>
      <button type="button" title={maximized ? '还原' : '最大化'} aria-label={maximized ? '还原' : '最大化'}
        ...
        {maximized ? (
          ...
          <svg width="11" height="11" viewBox="0 0 11 11"><rect x="0.7" y="0.7" width="9.6" height="9.6" fill="none" stroke="currentColor" strokeWidth="1" /></svg>
        )}
      </button>
      <button type="button" title="关闭" aria-label="关闭"
        ...
        <svg width="11" height="11" viewBox="0 0 11 11"><path d="M0.5 0.5 L10.5 10.5 M10.5 0.5 L0.5 10.5" stroke="currentColor" strokeWidth="1.1" /></svg>
      </button>
    </div>
  )
}
